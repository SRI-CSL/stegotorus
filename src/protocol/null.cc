...
null_config_t::null_config_t() : listen_addr(NULL), target_addr(NULL)
{
}
...
null_circuit_t::null_circuit_t()  : config(NULL), downstream(NULL)
{
}
...
null_conn_t::null_conn_t()  : config(NULL), upstream(NULL)
{
}
