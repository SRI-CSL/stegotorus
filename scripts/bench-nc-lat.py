...
def main():
    r = sys.stdout
    r.write("relay,lat,rate,obs,up,down\n")
	...
	starttime = time.time()
        ...
        latencies = range(100,650,50)
        rates = [50,150,300]

        t_direct(r, bench_fixedrate, latencies, rates)
        t_tor(r, bench_fixedrate, latencies, rates)
        t_storus(r, bench_fixedrate, "nosteg", 1, latencies, rates)
        t_storus(r, bench_fixedrate, "http", 2, latencies, rates)
        t_storus(r, bench_fixedrate, "http", 4, latencies, rates)
        t_storus(r, bench_fixedrate, "http", 6, latencies, rates)
        #t_storus(r, bench_fixedrate, "http", 8, latencies, rates)
        #t_storus(r, bench_fixedrate, "http",10, latencies, rates)
